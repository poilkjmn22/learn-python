...
type Module = typeof import("../newEntry.$topicId.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/newEntry.$topicId"
  file: "routes/newEntry.$topicId.tsx"
  path: "newEntry/:topicId/:entryId?"
  params: {"topicId": string; "entryId"?: string} & { [key: string]: string | undefined }
  module: Module
